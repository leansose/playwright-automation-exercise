...
test('place order with comment of one item', async ({ page }) => {
...
test.only('place order with multiple items and verify total price', async ({ page }) => {
...
test('verify address details in order after login', async ({ page }) => {
...
test('verify address details in order after registering', async ({ page }) => {
    ...
    await checkoutPage.verifyDeliveryAddress(randomUser.address);
    await checkoutPage.verifyBillingAddress(randomUser.address);
